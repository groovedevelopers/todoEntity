    ...
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var sp = host.Services.GetService<IServiceScopeFactory>()
                .CreateScope()
                .ServiceProvider;
            var options = sp.GetRequiredService<DbContextOptions<TodoContext>>();
        ...
        private static async Task EnsureDbCreatedAndSeedWithCountOfAsync(DbContextOptions<TodoContext> options, int count)
        {
